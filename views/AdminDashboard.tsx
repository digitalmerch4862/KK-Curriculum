                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button 
                      ...
                      className="relative z-10 flex items-center justify-center w-8 h-8 border-[2px] border-gray-200 rounded-full bg-white text-gray-400 hover:text-white hover:bg-red-500 hover:border-red-500 transition-all shadow-sm group"
                      title="Delete Lesson"
                    >
